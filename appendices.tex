...
\begin{figure}[ht]
    ...
    \centering
   \includegraphics[width = 1.0\linewidth]{plots/ptresolution_low.pdf}
   \centering (a)
     \end{minipage}
\end{figure}
...
\begin{figure}
    \centering
    \begin{minipage}[b]{0.95\linewidth}
    \includegraphics[width=1.0\textwidth]{plots/ptresolution_medium.pdf}
    \centering (b)
    \end{minipage}
    \quad
    \begin{minipage}[b]{0.95\linewidth}
    \includegraphics[width=1.0\textwidth]{plots/ptresolution_high.pdf}
    \centering (c$)$ 
    \end{minipage}
...
\begin{figure}[htpb]
    ...
    \centering
    \begin{minipage}[b]{0.95\linewidth}
    \includegraphics[width=1.0\textwidth]{plots/ptresolution_low.pdf}
    \centering (a)
    \end{minipage}
    \quad
    \begin{minipage}[b]{0.95\linewidth}
