...
A discussion of the \ac{SMS} signal models through which the analysis is interpreted, including a discussion on the signal efficiencies and systematics can be found in the following Chapter. 
