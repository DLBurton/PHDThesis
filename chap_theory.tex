...
This bottom-up approach allows for very heavy first and second generation squarks beyond the reach of the \ac{lhc}, whilst still providing a solution to the hierarchy problem where these quadratic corrections are cancelled out by the light stops as shown in Figure \ref{fig:stopcancellation}.
...
This presents an attractive option .... as still not experimentally detected, easy to detect... change the higgs in the figure to a $\phi$
