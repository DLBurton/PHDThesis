...
The theories that make up the SM are formulated mathematically using \acf{QFT}, in which particles are thought of as excitations of fields, and the dynamics of a given system are summarised in what is known as Lagrangian formalism.

Each fermion is described by a spinor field \spinor\xspace comprised of a pair of complex fields, the left-handed (\spinor$_{L}$) and right-handed (\spinor$_{R}$) representations.
