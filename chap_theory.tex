...
The simplest example of the application of the principle of local gauge invariance within the \ac{SM} is in \acf{QED}, the consequences of which require a massless photon field. 
...
Under a local U(1) gauge transformation in which \fermfield transforms as:
