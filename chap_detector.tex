...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.70]{plots/l1rateplot.pdf}
...
defined, reflecting the low, medium and high pile-up running conditions at \ac{CMS} in 2012. This is benchmarked relative to \Calo and \PF jets for the 2012 run C period where the jet seed threshold is applied, with \L1 single jet thresholds of 16, 36 and 92 \GeV, shown in Figure \ref{fig:l1jet-calopf-pu}. The results of fitting an \ac{EMG} function to these efficiency turn-on curves are given in Table \ref{tab:l1jcaloputable} and Table \ref{tab:l1pfputable} for \Calo and \PF jets respectively.
