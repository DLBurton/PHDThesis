...
The numerical results and extrapolation to the $n_{b}^{reco} =$3,4 bins for all \theht and working points is shown in Table \ref{tab:template_signal_table}. The excess of data is found and predictions from this method are found to be compatible with the \alphat maximum likelihood fit results from Table \ref{tab:fitsdata}.
